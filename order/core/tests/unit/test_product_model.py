...
class ProductModelTestCase(TestCase):
    ...
    def test_str_should_return_product_name_and_price_with_currency(self):
        product = Product(name="Notebook", currency=Product.CurrencyChoices.REAL, price=2_599_00)
